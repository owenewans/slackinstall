...
image. It boots the official Slackware64 15.0 installer, runs `slackinstall`
...
under `~/.cache/slackinstall-qemu/mirror`; each run gets a separate directory
containing its disk and console logs. Set `SLACKINSTALL_QEMU_DIR` to use a
